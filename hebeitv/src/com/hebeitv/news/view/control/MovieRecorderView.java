...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
    ...
    private void init(Context context, AttributeSet attrs){
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MovieRecorderView, 0, 0);
        ...
        mRecordMaxTime = a.getInteger(R.styleable.MovieRecorderView_record_max_time, FakeUtil.getValue(8, 2));// 默认为8
    ...
    private void initCamera() throws IOException {
        ...
        LogInfomation.d(TAG,"start Preview");
    ...
    private void createRecordDir() {
        File sampleDir = new File(Global_hebei.videoFilePath);
        if (!sampleDir.exists()) {
            sampleDir.mkdirs();
        }
