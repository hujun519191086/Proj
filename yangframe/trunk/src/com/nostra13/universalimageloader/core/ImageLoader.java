...
public class ImageLoader
{
     ...
     *            {@linkplain com.nostra13.universalimageloader.core.imageaware.ImageAware Image aware view} which should display image
     * @param options
     *            {@linkplain com.nostra13.universalimageloader.core.DisplayImageOptions Options} for image decoding and displaying. If <b>null</b> - default display image options
     *            {@linkplain ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(DisplayImageOptions) from configuration} will be used.
     * @throws IllegalStateException
     *             if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     * @throws IllegalArgumentException
     *             if passed <b>imageAware</b> is null
     ...
     *            {@linkplain com.nostra13.universalimageloader.core.listener.ImageLoadingProgressListener Listener} for image loading progress. Listener fires events on UI thread if this method is called on UI thread. Caching on disk
     *            should be enabled in {@linkplain com.nostra13.universalimageloader.core.DisplayImageOptions options} to make this listener work.
     * @throws IllegalStateException
     *             if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     * @throws IllegalArgumentException
     *             if passed <b>imageAware</b> is null
     ...
     *            Minimal size for {@link Bitmap} which will be returned in {@linkplain ImageLoadingListener#onLoadingComplete(String, android.view.View, android.graphics.Bitmap)} callback}. Downloaded image will be decoded and scaled to
     *            {@link Bitmap} of the size which is <b>equal or larger</b> (usually a bit larger) than incoming targetImageSize.
     * @param listener
     *            {@linkplain ImageLoadingListener Listener} for image loading process. Listener fires events on UI thread if this method is called on UI thread.
     * @throws IllegalStateException
     *             if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     ...
     * @param options
     *            {@linkplain com.nostra13.universalimageloader.core.DisplayImageOptions Options} for image decoding and displaying. If <b>null</b> - default display image options
     *            {@linkplain ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(DisplayImageOptions) from configuration} will be used.<br />
     * @param listener
     *            {@linkplain ImageLoadingListener Listener} for image loading process. Listener fires events on UI thread if this method is called on UI thread.
     * @throws IllegalStateException
     *             if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     ...
     *            Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
     * @param options
     *            {@linkplain com.nostra13.universalimageloader.core.DisplayImageOptions Options} for image decoding and scaling. If <b>null</b> - default display image options
     *            {@linkplain ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(DisplayImageOptions) from configuration} will be used.
     * @return Result image Bitmap. Can be <b>null</b> if image loading/decoding was failed or cancelled.
     * @throws IllegalStateException
     *             if {@link #init(ImageLoaderConfiguration)} method wasn't called before
