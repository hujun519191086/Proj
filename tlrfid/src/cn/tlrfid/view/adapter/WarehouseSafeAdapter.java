...
public class WarehouseSafeAdapter extends FrameAdapter {
	
	public WarehouseSafeAdapter(Context context) {
		super(context, null, 0);
		setItemHeightInPX(40);
	}
	
	private List<DeviceHelpBean> list;
	
	public void changeList(List<DeviceHelpBean> dbPbean) {
		this.list = dbPbean;
	...
	public View getItemView(int position, View convertView, ViewGroup parent) {
		...
		convertView = setConvertView_Holder(convertView, ViewHolder.class, R.layout.item_mainten_remind);
	...
	private void preperData(ViewHolder holder, DeviceHelpBean dpiBean) {
		...
		holder.tv_item_warehorse_factoryName.setText(dpiBean.getPurchaseDate());
		holder.tv_item_warehorse_modelName.setText(dpiBean.getUsefulLife());
		holder.tv_item_warehorse_personName.setText(dpiBean.getLastConserveDate());
		holder.tv_item_warehorse_conserveTypeName.setText(dpiBean.getNextConserveDate());
	}
}
