...
public class QualityCheckedActivity extends BaseActivity implements OnItemClickListener, OnFooterRefreshListener,
		OnHeaderRefreshListener {
	protected static final String TAG = "QualityCheckedActivity";
	@ViewById_Clickthis
	...
	private void initData() {
		...
		title_bar_content.setText("待整改质量检查记录");
			...
			public void handleMessage(Message msg) {
				...
				case 0:
					...
					if (mEpcList != null && mEpcList.size() > 0) {
						...
						mScan.setndCard(QualityCheckedActivity.this, mEpcList, ConstantValues.CURRICULUM_QUERY,
		...
		listen = new UHFReaderClass.OnEPCsListener() {
			...
			public void onEPCsRecv(ArrayList<String> EPCList) {
				LogUtil.d(TAG, "receiveRFID:" + EPCList);
	...
	private void searchCurriculum() {
		...
		HttpRequest request = new HttpRequest(this, new HttpRequestCallBack() {
			...
			public void success(String message) {
				...
				if (currVitae.state != 1) {
					SystemNotification.showToast(QualityCheckedActivity.this, currVitae.errMessage);
					return;
				}
			...
			@Override
			public void start() {
				AlertDialogUtil.showLoading(QualityCheckedActivity.this, "加载中...");
			}
		...
		}, ConstantValues.QUALITY_NEED_CHECKED, hashMap);
	...
	private void showCardDialog() {
		...
		final MyAlertDialogShow mads = new MyAlertDialogShow(this, view, mAdapter, "检查点列表", listen) {
	...
	public class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				holer = new Holder();
				convertView = View.inflate(QualityCheckedActivity.this, R.layout.item_scan, null);
		...
		public void addEPCs(ArrayList<ProjectCardBean> EPCs) {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		if (parent instanceof ListView) {
			...
			// startActivity(QualityNeedCheckedProjectActivity.class, "data", mItemList.get(position));
	...
	private void getSelfData(int id, final int position) {
			...
			public void success(String message) {
				...
				if (!StringUtils.isEmpty(message)) {
					try {
						...
						if (state == 1) {
							JSONArray arr = obj.getJSONArray("qualityCheckEntryList");
							SelfProjectRecoder recoder = mItemList.get(position);
							...
							startActivity(QualityNeedCheckedProjectActivity.class, "data", recoder);
							
						} else {
							SystemNotification.showToast(QualityCheckedActivity.this, obj.getString("errMessage"));
						}
					...
					SystemNotification.showToast(QualityCheckedActivity.this, "请求失败!");
				}
			}
		...
		}, ConstantValues.ITEM_QUALITY_CURR, map);
		request.execute();
	...
	public void onFooterRefresh(PullToRefreshView view) {
		if (isSearch) {
			if (mItemList.size() == currVitae.totalCount) {
				SystemNotification.showToast(QualityCheckedActivity.this, "没有更多数据了...");
