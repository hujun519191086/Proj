...
public class HttpRequest extends AsyncTask<Void, Void, String> {
	...
	public HttpRequest(Context context, HttpRequestCallBack callBack, String httpUrl, HashMap<String, String> httpParams) {
	...
	protected String doInBackground(Void... params) {
		...
		ret = HttpUtil.HttpGet(context, httpUrl, httpParams, 2);
