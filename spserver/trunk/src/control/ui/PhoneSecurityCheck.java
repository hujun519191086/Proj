...
public class PhoneSecurityCheck extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public PhoneSecurityCheck() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String strSec = request.getParameter("strSec");
		...
		if(WordUtil.isEmpty(strSec)&&strSec)
	}
