...
public class Insert2ShoppingCart extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Insert2ShoppingCart() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int buyCount = Integer.valueOf(request.getParameter("buyCount").toString());
		
		request.setAttribute("buyCount", buyCount);
		
		
		SingleFactory.ins().getShoppingCart().insert2ShoppingCart(request);
