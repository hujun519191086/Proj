...
public class LoadRecentPublish extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public LoadRecentPublish() {
		super();
	}
...
//				Double.valueOf(latitude));
		...
		DataPair<DBErrorCode, ArrayList<PublishHistory>> dp = SingleFactory
				.ins()
				.getBuyHistoryIns()
				.locationRecentPublish( Integer.valueOf(page),Integer.valueOf(pageCount),Long.valueOf(gid));
