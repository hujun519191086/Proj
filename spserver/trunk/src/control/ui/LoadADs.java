...
import control.bean.ADList;
import frame.SingleFactory;

public class LoadADs extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<AD> ad_list = SingleFactory.getADs();
		ADList al = new ADList();
		al.setAd_list(ad_list);
		
		out.write(JSONUtil.toJSON(al));
		out.flush();
		out.close();
	}
